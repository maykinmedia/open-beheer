...
def test_filter(page: Page, runner: GherkinRunner):
    _ = runner
    ...
    catalogus = _.given.catalogus_exists()
    _.given.zaaktypen_exist(catalogus, 20)
    ...
    # Search for zaaktype
    _.when.user_fills_form_field(page, "Zoek op identificatie", "18")
    _.then.page_should_not_contain_text(page, "ZAAKTYPE-2025-0000000020")
    _.then.page_should_not_contain_text(page, "ZAAKTYPE-2025-0000000019")
    _.then.page_should_contain_text(page, "ZAAKTYPE-2025-0000000018")
