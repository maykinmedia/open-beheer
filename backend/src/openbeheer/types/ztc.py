...
#   timestamp: 2025-08-07T15:01:46+00:00
#   version:   0.30.1
...
class BesluittypenGetParametersQuery(Struct, kw_only=True):
    ...
    datum_geldigheid: date | None = field(name="datumGeldigheid", default=None)
...
class ZaakobjecttypenGetParametersQuery(Struct, kw_only=True):
    ...
    catalogus: int | None = None
    datum_begin_geldigheid: date | None = field(
        name="datumBeginGeldigheid", default=None
    )
    datum_einde_geldigheid: date | None = field(
